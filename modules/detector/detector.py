...
sys.path.append("modules/detector/lib/utils")
sys.path.append("modules/detector/lib/utils")
print(sys.path)
# modules/detector/lib/models
...
from lib.utils.utils import create_logger, get_model_summary, get_optimizer, save_checkpoint
